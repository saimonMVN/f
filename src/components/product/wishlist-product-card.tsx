      ...
      <div className="flex ">
        ...
        <div className="flex flex-col ms-2 2xl:ms-3.5 h-full">
          ...
          <div className="space-s-2 ">
            <span className="inline-block font-medium text-sm sm:text-15px lg:text-base text-skin-base">
              {price}
            </span>
            {discount && (
      ...
      >
        {favorite ? (
          ...
          <>
            ...
            <span className="text-skin-primary ms-3 font-medium text-15px -mt-0.5 md:mt-0">
              {t('text-favorited')}
            </span>
          </>
        )}
