...
import ThumbnailCarousel from '@components/ui/carousel/thumbnail-carousel-bottom';
        ...
        <div className="col-span-5 xl:col-span-5 overflow-hidden mb-6 md:mb-8 lg:mb-0">
          {!!data?.gallery?.length ? (
                <ThumbnailCarousel
                    ...
                    thumbnailClassName="xl:w-full 2xl:w-full"
                    galleryClassName="xl:w-full 2xl:w-full"
                />
          ) : (
