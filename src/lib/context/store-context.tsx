...
import { CART_ID_COOKIE_EXPIRATION_DATE } from '@lib/constants';
...
const CART_KEY = AppConst.CART_COOKIES_ID;
...
export const StoreProvider = ({ children }: StoreProps) => {
  ...
  const storeCart = (id: string) => {
    if (!IS_SERVER) {
      ...
      const expirationDate = new Date(CART_ID_COOKIE_EXPIRATION_DATE);
      document.cookie = `${CART_KEY}=${id}; expires=${expirationDate.toUTCString()}; path=/`;      
    }
  };
